...
$(window).load(function() {
    ...
    $('.app-apple').on('mousedown', function () {
        yaCounter44882842.reachGoal('GOAPPSTORE')
    });
    $('.app-apple').on('touchstart', function () {
    	yaCounter44882842.reachGoal('GOAPPSTORE')
    });
    $('.app-google-play').on('mousedown', function () {
    	yaCounter44882842.reachGoal('GoGooglePlay')
    });
    $('.app-google-play').on('touchstart', function () {
    	yaCounter44882842.reachGoal('GoGooglePlay')
    });
