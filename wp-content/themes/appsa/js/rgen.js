...
; (function () {
	...
	********************************************/
	...
	rgen.global_validation = {
		...
		form_successMsg: "Спасибо, скоро мы Вам ответим",
			...
			$.ajax({
				...
				success: function (data) {
					if (data.status == 'error') {
						...
						if( data.data.ya_params != undefined ){
                            var metrika_params = data.data.ya_params;
						}
						if ( data.data.ya_goal != undefined ) {
							yaCounter44882842.reachGoal(data.data.ya_goal,metrika_params||{});
						}
						if ( data.data.metrika_goal != undefined ) {
							yaCounter44882842.reachGoal(data.data.metrika_goal);
						}
